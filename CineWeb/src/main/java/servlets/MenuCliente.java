...
/**
 * Servlet implementation class MenuCliente
 */
@WebServlet({ "/Admin/Clientes/MenuCliente" })
public class MenuCliente extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			clientes = pl.getClientes();
 			request.setAttribute("clientes", clientes);
 			request.getRequestDispatcher("/Admin/Clientes/MenuClientes.jsp").forward(request, response);
