    ...
    <nav class="navbar navbar-expand-sm navbar-dark p-3 bg-dark fixed-top" data-bs-theme="dark">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a href="Admin/Clientes/MenuCliente" class="nav-link">Clientes</a></li>
		  ...
		  <li class="nav-item"><a href="Cliente/Profile" class="nav-link">Mi perfil</a></li>
          <%} else if (p!= null){%>
