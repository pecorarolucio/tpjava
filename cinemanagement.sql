...
INSERT INTO `usuario` VALUES (1,'admin','admin','admin@admin','admin','Admin'),(2,'alejo','pereira','af@g.com','ale123','Cliente'),(3,'tomas','salva','admin@g.com','asd','Cliente'),(4,'matias','secchini','lb@g.com','lea123','Cliente'),(5,'tomas','soto','mc@g.com','mati123','Cliente'),(6,'luigi','mario','lg@g.com','lg123','Cliente'),(7,'violeta','martines','vt@g.com','tieppo123','Cliente'),(8,'cliente','cliente','cliente@cliente','cliente','Cliente');
