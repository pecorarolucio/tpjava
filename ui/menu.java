...
public class menu {
	...
	private void executeCommand(String command) {
		...
		switch (command) {
		case "list":
			System.out.print("Que desea listar? (1-Categorias/2-Salas/3-Peliculas): ");
			opc=Integer.parseInt(s.nextLine());
			if (opc == 1) {
			System.out.println(categoriaABMC.getAll());
			} else  {System.out.println(salaABMC.getAll());}
			break;
		case "add":
			add();
			break;
	...
	private void add() {
		int opc2;
		System.out.print("Que desea añadir? (1-Categoria/2-Sala/3-Pelicula): ");
